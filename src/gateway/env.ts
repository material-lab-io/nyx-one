...
export function buildEnvVars(env: MoltbotEnv): Record<string, string> {
  ...
  if (env.WHATSAPP_GROUP_POLICY) envVars.WHATSAPP_GROUP_POLICY = env.WHATSAPP_GROUP_POLICY;
  if (env.WHATSAPP_GROUPS) envVars.WHATSAPP_GROUPS = env.WHATSAPP_GROUPS;
  if (env.WHATSAPP_CREDS_JSON) envVars.WHATSAPP_CREDS_JSON = env.WHATSAPP_CREDS_JSON;
